...
sudo apt-get update && sudo apt-get install -y postgresql-9.5 \
...
sudo wget http://mirror.navercorp.com/apache/tomcat/tomcat-8/v8.0.52/bin/apache-tomcat-8.0.52.tar.gz
sudo tar -xvf apache-tomcat-8.0.52.tar.gz
sudo mv apache-tomcat-8.0.52 ApplicationServer
...
sudo tar -xvf apache-tomcat-8.0.52.tar.gz
sudo mv apache-tomcat-8.0.52 DataServer
sudo rm apache-tomcat-8.0.52.tar.gz
