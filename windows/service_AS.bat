...
set CATALINA_HOME=C:\Servers\ApplicationServer
set SERVICE_NAME=ApplicationServer8
set PR_DISPLAYNAME=Apache Tomcat ApplicationServer 8
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    --Description "Apache Tomcat 8.0.33 Server - http://tomcat.apache.org/" ^
